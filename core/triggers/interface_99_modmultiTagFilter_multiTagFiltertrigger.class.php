...
/**
 * 	\file		core/triggers/interface_99_modMyodule_multiTagFiltertrigger.class.php
 * 	\ingroup	multitagfilter
 * 	\brief		Sample trigger
 * 	\remarks	You can create other triggers by copying this one
 * 				- File name should be either:
 * 					interface_99_modMultitagfilter_Mytrigger.class.php
 ...
 * Trigger class
 */
class InterfacemultiTagFiltertrigger
{
